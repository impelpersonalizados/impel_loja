function getAllowedOrigin(request, env) {
  ...
  // Se não houver Origin (ex: curl / servidor), permitimos sem setar origin específico
  if (!origin) return null;

  // Permite apenas o domínio do GitHub Pages configurado
